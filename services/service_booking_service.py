...
from control_panel.models import ServiceBookingModel

class ServiceBookingModelService:
    def get_all_bookings(self):
        """
        Fetch all service bookings from the database.
        :return: Queryset of all ServiceBookingModel instances.
        """
    ...
    def get_booking_by_id(self, pk):
        ...
        :return: ServiceBookingModel instance if found, None otherwise.
        """
        try:
    ...
    def update_booking(self, booking, validated_data):
        ...
        :param booking: ServiceBookingModel instance to be updated.
        :param validated_data: A dictionary of data to update the booking with.
        :return: Updated ServiceBookingModel instance.
    ...
    def delete_booking(self, booking):
        ...
        :param booking: ServiceBookingModel instance to be deleted.
        :return: None
